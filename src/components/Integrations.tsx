...
const row1 = [
  ...
  {
    logo: <CodeBracketIcon className="w-11 h-11" style={{ color: "#29ABE2" }} />,
  ...
  {
    logo: (
      <svg viewBox="0 0 36 36" className="w-11 h-11"><rect width="36" height="36" rx="8" fill="#0088CC"/><path d="M18 8C12.477 8 8 12.239 8 17.469c0 2.944 1.406 5.57 3.608 7.316L10.5 28l3.428-1.056A10.3 10.3 0 0 0 18 27.938c5.523 0 10-4.239 10-9.469S23.523 8 18 8Z" fill="white"/></svg>
    ),
    name: "Telegram Bot",
...
const row2 = [
  ...
  {
    logo: (
      <svg viewBox="0 0 36 36" className="w-11 h-11"><rect width="36" height="36" rx="8" fill="#1877F2"/><path d="M22.5 18h-3v10h-4V18h-2v-3.5h2v-2c0-2.8 1.2-4.5 4.5-4.5H22v3.5h-1.5c-1 0-1.5.4-1.5 1.5v1.5H22l-.5 3.5Z" fill="white"/></svg>
    ),
    name: "Facebook / Meta",
  ...
  {
    logo: (
      <svg viewBox="0 0 36 36" className="w-11 h-11"><rect width="36" height="36" rx="8" fill="#fff" stroke="#E5E7EB"/><text x="18" y="24" textAnchor="middle" fontSize="14" fontWeight="800" fill="#4285F4" fontFamily="Arial">G</text></svg>
    ),
    name: "Google Drive",
...
export default function Integrations() {
  ...
  // RAF-based pixel-perfect seamless marquee (no CSS animation → no visible loop reset)
  useEffect(() => {
    let rafId: number;
    let paused = false;
    let x1 = 0;
